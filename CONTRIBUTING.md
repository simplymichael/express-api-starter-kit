...
2.  Clone the repo: `git clone https://github.com/<your-github-username>/express-api-starter-kit`.
3.  Navigate to the repo's directory: `cd express-api-starter-kit`.
...
>
> ```bash
> git remote add upstream https://github.com/simplymichael/express-api-starter-kit.git
> git fetch upstream
...
[issues]: https://github.com/simplymichael/express-api-starter-kit/issues
